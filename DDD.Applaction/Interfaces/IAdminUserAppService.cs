...
namespace DDD.Applaction.AdminUsers.Interfaces
{
    ...
    {
        Task<Result<int>> CreateAsync(AdminUserCommand.Create command, CancellationToken cancellationToken);
        ...
        Task<Result<int>> UpdateAsync(AdminUserCommand.Update command, CancellationToken cancellationToken);
    }
}